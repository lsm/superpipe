...
var Pipeline = module.exports = function Pipeline(superpipe) {
  var pipeline = assign(function(superpipe) {
    pipeline.toPipe(superpipe, undefined, undefined)()
  }, Pipeline.prototype)
...
Pipeline.prototype.toPipe = function(superpipe, begin, end) {
  var pipeline = superpipe ? this.clone(superpipe) : this
  return Pipeline.toPipe(pipeline, slice(pipeline.pipes, begin, end))
}
...
Pipeline.prototype.toCurriedPipe = function(begin, end) {
  ...
  return function(superpipe) {
    ...
    return self.toPipe(null, begin, end)
  }
}
