...
var Pipeline = module.exports = function Pipeline(superpipe) {
  var pipeline = assign(function(superpipe) {
    pipeline.toPipe(undefined, undefined, superpipe)()
  }, Pipeline.prototype)
...
Pipeline.prototype.buildPipe = function(fn, deps, supplies) {
  ...
  if (supplies && !isArray(supplies))
    throw new Error('supplies should be either string or array of dependency names')
  ...
  return {
    ...
    ofn: fn, // The ofn property might be changed during pipeline execution
    deps: deps,
    fnName: getFnName(fn),
    supplies: supplies
  }
...
Pipeline.prototype.toPipe = function(begin, end, superpipe) {
  this.connect(superpipe)
  return Pipeline.toPipe(this, slice(this.pipes, begin, end), superpipe)
}

Pipeline.prototype.toCurriedPipe = function(begin, end) {
  var self = this
  return function(superpipe) {
    return self.toPipe(begin, end, superpipe)
  }
}
