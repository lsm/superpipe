import type { Pipe, OutputMap } from './types'
...
function buildPipe(
  ...
  return {
    ...
    outputMap: normalizedOutput.outputMap
  }
}
...
function normalizeOutput(output?: string | string[]): NormalizedOutput {
  let result: string[]
  ...
  let outputMap: OutputMap | undefined
